...
def predict():
	if request.method=="POST":
		...
		lic_data=cv2.CascadeClassifier("india_license_plate.xml")


		imgGray = cv2.cvtColor(src, cv2.COLOR_BGR2GRAY)

		numberPlates = lic_data.detectMultiScale(imgGray, 1.1, 4)
